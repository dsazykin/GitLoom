...
/// logic — a second copy is a review rejection trigger. <see cref="Mainguard.Git.Hosting"/>'s
/// GitHubApiClient and the P2-01 <see cref="Mainguard.Git.Security.ApiKeyHealthService"/> both
