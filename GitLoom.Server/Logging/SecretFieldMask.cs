...
/// commented <c>// SECRET</c> in <c>GitLoom.Protos/protos/**</c> MUST be registered
...
///
/// The reviewer grep (<c>grep -rn "SECRET" GitLoom.Protos/protos/</c>) and the
