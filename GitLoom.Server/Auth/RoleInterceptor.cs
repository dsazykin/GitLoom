...
public sealed class RoleInterceptor : Interceptor
{
    ...
    {
        "/gitloom.v1.MergeQueueService/BeginMerge",
        "/gitloom.v1.MergeQueueService/ConfirmMerge",
        "/gitloom.v1.PlanApprovalService/ApprovePlan",
        "/gitloom.v1.PlanApprovalService/RejectPlan",
    };

    private const string AttachMethod = "/gitloom.v1.TerminalService/Attach";
