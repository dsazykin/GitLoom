...
public class DaemonLogsRenderHarness
{
    ...
    private const string SampleJournal =
        ...
        + "2026-07-18T09:14:21.4600000+00:00 [INF] [rpc] () rpc-end method=/gitloom.v1.AgentService/SpawnAgent status=OK duration_ms=1131 request=model_api_key=*** kind=claude-code\n"
