...
public static class TerminalHarnessPaths
{
    ...
    /// <summary><c>GitLoom.Tests/Terminal/</c> — harness sources + allowlist.</summary>
    public static string TerminalDir => Path.Combine(RepoRoot, "GitLoom.Tests", "Terminal");

    /// <summary><c>GitLoom.Tests/Transcripts/</c> — recorded <c>.bytes</c> + committed <c>.golden</c>.</summary>
    public static string TranscriptsDir => Path.Combine(RepoRoot, "GitLoom.Tests", "Transcripts");
