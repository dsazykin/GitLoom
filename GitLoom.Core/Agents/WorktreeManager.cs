...
public sealed class WorktreeManager : IAgentWorktreeManager
{
    ...
    /// This is the ONE process launch in <c>GitLoom.Core/Agents</c> — all git goes through the
    ...
    {
        // The single, injectable, real process launch in GitLoom.Core/Agents. Git never spawns here.
