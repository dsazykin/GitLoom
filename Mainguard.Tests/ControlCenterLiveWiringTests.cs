...
/// <c>AlphaControlCenterProjectionTests</c> in Mainguard.Server.Tests (merge/plan/kill/telemetry/coordinator).
/// </summary>
public sealed class ControlCenterLiveWiringTests
{
    ...
    {
        var bundle = Mainguard.Agents.UI.Editions.ProComposition.CreateProduction();
        try
        {
    ...
    /// <summary>The default factory the app uses (<see cref="Mainguard.Agents.UI.Editions.ProComposition.CreateOrchestratorServices"/>)
    ...
    public void DefaultFactory_IsProductionNonMock()
    {
        ...
        Mainguard.Agents.UI.Editions.ProComposition.OrchestratorServicesFactory = Mainguard.Agents.UI.Editions.ProComposition.CreateProduction;

        var bundle = Mainguard.Agents.UI.Editions.ProComposition.CreateOrchestratorServices();
        try
        {
            AssertNotMock(bundle.Agents, nameof(bundle.Agents));
            Assert.IsType<DaemonBackedOrchestrator>(bundle.Agents);
