...
/// <c>Mainguard.Tests.ProbeViewModel</c> full name transforms to <c>Mainguard.Tests.ProbeView</c> — a type the
...
public class ViewLocatorCrossAssemblyTests
{
    ...
    public void Build_ResolvesProbeView_OnlyWhenItsAssemblyIsRegistered()
    {
        ...
        try
        {
            ...
            Assert.Equal("Not Found: Mainguard.Tests.ProbeView", placeholder.Text);
