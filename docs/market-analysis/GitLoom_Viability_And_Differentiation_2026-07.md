# GitLoom — Viability Re-Assessment & Differentiation Research
...
**Supersedes nothing** — reads alongside `GitLoom_Market_Research_v2.md`; this is a point-in-time
...
**Consequence:** "GitLoom spawns agents in isolated worktrees" is not a product. It is a
...
2. **Almost everything is Mac-first or terminal-first.** The Windows/WSL2 enterprise developer —
   exactly GitLoom's locked architecture — is served by approximately nobody with a polished product.

### 1.3 The bottleneck moved from generation to verification

This is the strongest finding, and it points *toward* GitLoom's actual strengths:
...
after-the-fact log review. None of the orchestrator GUIs above ship any of this. GitLoom's
...
4. Marketing/positioning docs should stop leading with "swarm control center" and lead with
   review throughput + governance; update `GitLoom_Roadmap.md` framing when it is next touched.
