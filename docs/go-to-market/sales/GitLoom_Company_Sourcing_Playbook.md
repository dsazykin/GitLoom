# GitLoom — Target-Company Sourcing Playbook

**Date:** 2026-07-11 · **Register:** brand (sales/GTM execution layer)
**Reads under:** `docs/go-to-market/GitLoom_Master_Market_Document_2026-07.md` — the ICP (§4.5),
...
`GitLoom_Outreach_And_Pitch_Kit.md`; this document answers one question: **how do we find them.**
...
2. **The self-report question** ("where did you hear about GitLoom?" — paid-media plan §1) doubles as
