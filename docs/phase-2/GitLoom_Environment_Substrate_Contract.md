...
**Status:** Draft for review · **Revision:** 2026-07-11 (initial cut) · **Subordinate to:** `docs/phase-2/implementation_plans/GitLoom_Master_Implementation_Document_v2.md` (the binding spec) and consistent with `docs/phase-2/GitLoom_Orchestration_Protocol_Spec.md` (OPS v1). Where this document and the master doc disagree, **the master doc wins** and the disagreement is drift to be fixed here — the same precedence rule AGENTS.md applies to CLAUDE.md and OPS applies to itself.
...
> **Affected tasks:** P2-06/P2-07 test contracts; the phase-2 test-implementation strategy (`docs/phase-2/implementation_plans/GitLoom_Test_Implementation_Strategy_v2.md`).
